...
const EditHomeA4 = ({ route, navigation }) => {
  ...
  const { banneid, bannername } = route.params;
  ...
  const fetchDataForImages = async () => {
    try {
      const apiUrl = `https://api.brandingprofitable.com/a4data/a4data/${banneid}`;
      ...
      if (videos.length === 0) {
        ...
        setSelectedVideo('https://cdn.brandingprofitable.com/' + videos[0].a4_data_image);
      }
      ...
      if (items.length !== 0) {
        setItem("https://cdn.brandingprofitable.com/" + items[0].a4_data_image);
  ...
  //   if (i < 2) {
  //     if (items.length > 0) {
  //       const a4_data_image = items[0].a4_data_image == undefined ? "https://static.vecteezy.com/system/resources/previews/023/914/428/non_2x/no-document-or-data-found-ui-illustration-design-free-vector.jpg" : "https://cdn.brandingprofitable.com/" + items[0].a4_data_image
  //       setItem(a4_data_image)
  //       seti(i)
  //     }
  //   } else {
  ...
  const handleImagePressV = (item) => {
    ...
    setSelectedVideo("https://cdn.brandingprofitable.com/" + item.a4_data_image);
  };
  ...
  const renderItem = useCallback(({ item }) => (
    <TouchableOpacity onPress={() => handleImagePress("https://cdn.brandingprofitable.com/" + item.a4_data_image)}>
      <FastImage source={{ uri: "https://cdn.brandingprofitable.com/" + (item.comp_iamge || item.a4_data_image) }} style={styles.image} onLoadEnd={() => Image.prefetch("https://cdn.brandingprofitable.com/" + (item.comp_iamge || item.a4_data_image))} />
    </TouchableOpacity>
  ), []);
  ...
  //       <FastImage source={{ uri: "https://cdn.brandingprofitable.com/" + item.a4_data_image }} style={styles.image} onLoadEnd={() => Image.prefetch("https://cdn.brandingprofitable.com/" + item.a4_data_image)} />
  ...
  //   return (
  //     <TouchableOpacity onPress={() => handleImagePressV(item)}>
  //       <FastImage source={{ uri: "https://cdn.brandingprofitable.com/"+item.a4_data_image, priority: FastImage.priority.high, cache: FastImage.cacheControl.cacheOnly}} resizeMode={FastImage.resizeMode.contain} style={styles.image} />
  //       <View style={{ position: 'absolute', top: 45, left: 45, zIndex: 1 }}>
  //         <Icon name="play-circle" size={30} color={"white"} />
  //       </View>
  //     </TouchableOpacity>
  ...
  //     </View>
  //     <Video
  //       source={{ uri: "https://cdn.brandingprofitable.com/" + item.a4_data_image }}
  //       repeat={false}
  //       paused={false}
  //       style={styles.image}
  //       resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  overlayImage: {
    ...
    borderRadius: 10,
    width: 300,
    height: 375 ,// Adjust the height to maintain the aspect ratio
    resizeMode: 'stretch', 
  },
  mainImage: {
    width: 300, height: 375,

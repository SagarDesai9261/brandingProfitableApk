...
const AfterSubscribeAbcd = ({ profileData, userTeamDetails, fetchMLMData }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (userTeamDetails1.data.is_mlm) {
    ...
    //   try {
    //     if (profileData?.mobileNumber) {
    //       console.log('Checking subscription status...aftersubscribeAbcd');
    //       const response = await axios.get(
...
<TextInput
                        ...
                        <View style={{ height: 80, width: '100', justifyContent: 'space-around', flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                <View>
                                    ...
                                    <Text style={{ fontFamily: 'Manrope-Bold', fontSize: 14, color: 'white' }}>
                                        ₹ {userTeamDetails1?.greenWallet || userTeamDetails1?.green_wallet}/-
                                    </Text>
                                </View>
                            </View>
                        </View>
                ...
                {/* <View style={{ height: 100, justifyContent: 'center', alignItems: 'center', gap: 10, backgroundColor: 'rgba(0, 0, 0, 0.8)', marginTop: 30, borderRadius: 0 }}>
                    ...
                    <TouchableOpacity onPress={() => { navigation.navigate('MLMScreen2', { 'aadhar': profileData?.mobileNumber, 'id': profileData?._id, 'greenWallet': userTeamDetails1?.greenWallet || userTeamDetails1?.green_wallet }) }}>
                        <Text style={{ color: '#00D3FF', fontFamily: 'Manrope-Bold', fontSize: 15, textDecorationLine: 'underline', }}>
                            Total Team
                        </Text>
                    </TouchableOpacity>
                ...
                <View style={{ height: 180, justifyContent: 'space-between', flexDirection: 'row', gap: 5, marginTop: 30, borderRadius: 0, paddingHorizontal:10 }}>
                    <View style={{ borderRadius: 15, height: '100%', width: '45%', backgroundColor: 'rgba(255, 255, 255, 0.8)', overflow: 'hidden', }}>
                        ...
                        <View>
                            <View style={{ justifyContent: 'center', width: '100%', height: '100%', gap: 5, padding: 20 }}>

                                <MaterialIcons name="supervised-user-circle" size={50} color="black" style={{ marginLeft: -5 }} />
                                <Text style={{ fontSize: 18, fontFamily: 'Manrope-Bold' }}>Referals</Text>

                                <View>

                                    <Text style={{ fontFamily: 'Manrope-Regular' }}>
                                        History of Your referrals
                                    </Text>
                                </View>

                                <TouchableOpacity style={{ alignItems: 'center', flexDirection: 'row', marginTop: 10 }} onPress={()=>{navigation.navigate('ReferralHistory', {mobileNumber: profileData?.mobileNumber})}}>
                                    <Text style={{ fontFamily: 'Manrope-Bolds', fontSize: 18, color:'green' }}>
                                        View History
                                    </Text>
                    ...
                    <View style={{ borderRadius: 15, height: '100%', width: '45%', backgroundColor: 'rgba(255, 255, 255, 0.8)', overflow: 'hidden', }}>
                        ...
                        <View>
                            <View style={{ justifyContent: 'center', width: '100%', height: '100%', gap: 5, padding: 20 }}>
                                ...
                                <MaterialIcons name="wallet" size={50} color="black" style={{ marginLeft: -5 }} />
                                <Text style={{ fontSize: 18, fontFamily: 'Manrope-Bold' }}>Withdrawals</Text>

                                <View>

                                    <Text style={{ fontFamily: 'Manrope-Regular' }}>
                                        History of Your Withdraw
                                    </Text>
                                </View>

                                <TouchableOpacity style={{ alignItems: 'center', flexDirection: 'row', marginTop: 10 }} onPress={()=>{navigation.navigate('WithdrawHistoryAbcd', {mobileNumber: profileData?.mobileNumber})}}>
                                    <Text style={{ fontFamily: 'Manrope-Bolds', fontSize: 18, color:'green' }}>
                                        View History
                                    </Text>
                                    <MaterialIcons name="chevron-right" size={25} color="green" />
                ...
                <View style={{ height: 150, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.7)', marginTop: 50, borderRadius: 10, marginBottom: 80 }}>
                    ...
                    <TouchableOpacity style={{ justifyContent: 'space-between', marginTop: 10, width: '80%', flexDirection: 'row', alignItems: 'center' }} onPress={()=>{navigation.navigate('UpgradePlan')}}>
...
export default AfterSubscribeAbcd

...
const CategoriesScreen = ({ route, navigation }) => {
    ...
    useEffect(() => {
        ...
        const apiUrl = 'https://api.brandingprofitable.com/trending_section/trendingandnews_item';
    ...
    console.log(data, "data in trending screen.")
    ...
    const renderItem = useCallback(({ item }) => {
      ...
      //  console.log(item.todayAndTomorrowImageOrVideo)
            ...
            <FlatList
                ...
                renderItem={({ item: imageItem, index }) => (
                    ...
                    >
                        ...
                        <FastImage
                            source={{ uri:  "https://cdn.brandingprofitable.com/" + imageItem.todayAndTomorrowImageOrVideo, priority: FastImage.priority.normal }}
                            style={[styles.image, { marginLeft: index == 0 ? 15 : 0 }]}
                            onLoadEnd={() => Image.prefetch("https://cdn.brandingprofitable.com/" + imageItem.todayAndTomorrowImageOrVideo)}
                        />
                    </TouchableOpacity>
                )}
            />

...
const FullScreenProfile = ({ navigation }) => {
    ...
    const fetchData = async () => {
        try {
            ...
            console.log('Error fetching data... view profile:', error);
        }
        setLoading(false);
    };
        ...
        <LinearGradient colors={['#050505', '#1A2A3D']}
            ...
            <ScrollView style={styles.container}>
                ...
                <View style={styles.profileContainer}>
                    ...
                    { businessOrPersonal=='business' && renderTextInput('Website Link', profileData?.website, (text) => setProfileData({ ...profileData, website: text }))}
                    {/* DOB */}
                    <View style={[styles.labelContainer, { marginTop: 20 }]}>
                        <Text style={styles.label}>

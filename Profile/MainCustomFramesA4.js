...
const aspectRatio = 300 / 375; // Desired aspect ratio
...
const SavedFrames = ({ navigation }) => {
    ...
    const fetchData = async () => {
        ...
        setRefreshing(true);
        try {
            const response = await axios.get('https://api.brandingprofitable.com/a4frame/frameimage');
    ...
    const handleSelect = (item) => {
        navigation.navigate('CustomFrameFormProfile', { 'itemId': item._id, isRequest: 'no', isA4: 'yes' });
    }

...
const History = ({route}) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://api.brandingprofitable.com/mlm/userhistory/${mobileNumber}/G_Royalty`);
    ...
    return (
        <LinearGradient colors={['#050505', '#1A2A3D']} style={{ flex: 1 }}>
            <Text style={styles.header}>Global Royalty History</Text>

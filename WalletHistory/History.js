...
const History = ({route}) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://api.brandingprofitable.com/mlm/userhistory/${mobileNumber}/All`);
                        ...
                        <View key={index} style={styles.transactionContainer}>
                            ...
                            <View style={{ flexDirection: 'row', gap: 15 }}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.transactionText2}>Tra. Id - {item.transaction_id}</Text>
                                </View>
                            </View>

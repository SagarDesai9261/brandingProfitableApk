...
const History = ({route}) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://api.brandingprofitable.com/mlm/userhistory/${mobileNumber}/Sponsor`);
    ...
    return (
        <LinearGradient colors={['#050505', '#1A2A3D']} style={{ flex: 1 }}>
            <Text style={styles.header}>Sponsor Income History</Text>
